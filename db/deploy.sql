...
CREATE FUNCTION verge_customization.can_read_usage(_user_id uuid) RETURNS boolean
  ...
  SELECT auth.uid() IS NULL
      ...
      OR verge_customization.has_role(auth.uid(), 'super_admin'::app_role)
      OR verge_customization.is_staff_of(auth.uid(), _user_id)
$$;
...
DECLARE c integer;
BEGIN
  IF NOT verge_customization.can_read_usage(_user_id) THEN
    RAISE EXCEPTION 'Not authorized';
  END IF;
  SELECT COUNT(*) INTO c
  FROM verge_customization.ai_usage_logs
...
BEGIN
  ...
  FROM verge_customization.contact_usage
  WHERE user_id = _user_id AND created_at >= _since;
  RETURN COALESCE(c, 0);
END;
$$;
...
BEGIN
  RETURN EXISTS (
    SELECT 1 FROM verge_customization.profiles
...
CREATE TABLE verge_customization.profiles (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    plan_tier verge_customization.plan_tier DEFAULT 'free'::verge_customization.plan_tier NOT NULL,
    is_active boolean DEFAULT true NOT NULL,
    business_name text,
...
CREATE TABLE verge_customization.user_roles (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
    role verge_customization.app_role DEFAULT 'business_user'::verge_customization.app_role NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE ONLY verge_customization.faq_usage_logs
    ADD CONSTRAINT faq_usage_logs_faq_id_fkey FOREIGN KEY (faq_id) REFERENCES verge_customization.faqs(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY verge_customization.faqs
    ADD CONSTRAINT faqs_product_id_fkey FOREIGN KEY (product_id) REFERENCES verge_customization.products(id) ON DELETE SET NULL;
...
CREATE POLICY "Staff can create owner conversations" ON verge_customization.conversations FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM verge_customization.staff_accounts sa
...
--
-- Name: SCHEMA verge_customization; Type: ACL; Schema: -; Owner: -
--

GRANT USAGE ON SCHEMA verge_customization TO postgres;
GRANT USAGE ON SCHEMA verge_customization TO anon;
GRANT USAGE ON SCHEMA verge_customization TO authenticated;
GRANT USAGE ON SCHEMA verge_customization TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.can_read_usage(_user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION verge_customization.can_read_usage(_user_id uuid) TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.enforce_order_limit() TO authenticated;
GRANT ALL ON FUNCTION verge_customization.enforce_order_limit() TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.get_ai_message_usage(_user_id uuid, _since timestamp with time zone) TO authenticated;
GRANT ALL ON FUNCTION verge_customization.get_ai_message_usage(_user_id uuid, _since timestamp with time zone) TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.get_contact_usage(_user_id uuid, _since timestamp with time zone) TO authenticated;
GRANT ALL ON FUNCTION verge_customization.get_contact_usage(_user_id uuid, _since timestamp with time zone) TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.get_staff_owner_id(_user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION verge_customization.get_staff_owner_id(_user_id uuid) TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.handle_new_user() TO authenticated;
GRANT ALL ON FUNCTION verge_customization.handle_new_user() TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.handle_new_user_role() TO authenticated;
GRANT ALL ON FUNCTION verge_customization.handle_new_user_role() TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.handle_new_user_settings() TO authenticated;
GRANT ALL ON FUNCTION verge_customization.handle_new_user_settings() TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.has_role(_user_id uuid, _role verge_customization.app_role) TO authenticated;
GRANT ALL ON FUNCTION verge_customization.has_role(_user_id uuid, _role verge_customization.app_role) TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.is_admin() TO authenticated;
GRANT ALL ON FUNCTION verge_customization.is_admin() TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.is_staff_of(_staff_user_id uuid, _owner_id uuid) TO authenticated;
GRANT ALL ON FUNCTION verge_customization.is_staff_of(_staff_user_id uuid, _owner_id uuid) TO service_role;
...
GRANT ALL ON FUNCTION verge_customization.update_updated_at_column() TO authenticated;
GRANT ALL ON FUNCTION verge_customization.update_updated_at_column() TO service_role;
...
GRANT ALL ON TABLE verge_customization.ai_usage_logs TO authenticated;
GRANT ALL ON TABLE verge_customization.ai_usage_logs TO service_role;
...
GRANT ALL ON TABLE verge_customization.chat_takeovers TO authenticated;
GRANT ALL ON TABLE verge_customization.chat_takeovers TO service_role;
...
GRANT ALL ON TABLE verge_customization.contact_usage TO authenticated;
GRANT ALL ON TABLE verge_customization.contact_usage TO service_role;
...
GRANT ALL ON TABLE verge_customization.conversations TO authenticated;
GRANT ALL ON TABLE verge_customization.conversations TO service_role;
...
GRANT ALL ON TABLE verge_customization.faq_usage_logs TO authenticated;
GRANT ALL ON TABLE verge_customization.faq_usage_logs TO service_role;
...
GRANT ALL ON TABLE verge_customization.faqs TO authenticated;
GRANT ALL ON TABLE verge_customization.faqs TO service_role;
...
GRANT ALL ON TABLE verge_customization.fcm_tokens TO authenticated;
GRANT ALL ON TABLE verge_customization.fcm_tokens TO service_role;
...
GRANT ALL ON TABLE verge_customization.leads TO authenticated;
GRANT ALL ON TABLE verge_customization.leads TO service_role;
...
GRANT ALL ON TABLE verge_customization.message_queue TO authenticated;
GRANT ALL ON TABLE verge_customization.message_queue TO service_role;
...
GRANT ALL ON TABLE verge_customization.orders TO authenticated;
GRANT ALL ON TABLE verge_customization.orders TO service_role;
...
GRANT ALL ON TABLE verge_customization.platform_settings TO authenticated;
GRANT ALL ON TABLE verge_customization.platform_settings TO service_role;
...
GRANT ALL ON TABLE verge_customization.products TO authenticated;
GRANT ALL ON TABLE verge_customization.products TO service_role;
...
GRANT ALL ON TABLE verge_customization.profiles TO authenticated;
GRANT ALL ON TABLE verge_customization.profiles TO service_role;
...
GRANT ALL ON TABLE verge_customization.settings TO authenticated;
GRANT ALL ON TABLE verge_customization.settings TO service_role;
...
GRANT ALL ON TABLE verge_customization.staff_accounts TO authenticated;
GRANT ALL ON TABLE verge_customization.staff_accounts TO service_role;
...
GRANT ALL ON TABLE verge_customization.user_roles TO authenticated;
GRANT ALL ON TABLE verge_customization.user_roles TO service_role;
...
GRANT ALL ON TABLE verge_customization.user_wsender_sessions TO authenticated;
GRANT ALL ON TABLE verge_customization.user_wsender_sessions TO service_role;
...
-- Auth Triggers
DROP TRIGGER IF EXISTS on_auth_user_created_verge_customization ON auth.users;
CREATE TRIGGER on_auth_user_created_verge_customization
  AFTER INSERT ON auth.users
  FOR EACH ROW
  EXECUTE FUNCTION verge_customization.handle_new_user();

DROP TRIGGER IF EXISTS on_auth_user_created_role_verge_customization ON auth.users;
CREATE TRIGGER on_auth_user_created_role_verge_customization
  AFTER INSERT ON auth.users
  FOR EACH ROW
  EXECUTE FUNCTION verge_customization.handle_new_user_role();

DROP TRIGGER IF EXISTS on_auth_user_created_settings_verge_customization ON auth.users;
CREATE TRIGGER on_auth_user_created_settings_verge_customization
  AFTER INSERT ON auth.users
  FOR EACH ROW
  EXECUTE FUNCTION verge_customization.handle_new_user_settings();
